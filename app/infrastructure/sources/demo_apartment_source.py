...
DISTRICTS = (
    ...
    # === ВОСТОЧНЫЕ РАЙОНЫ ===
    {
        ...
        'streets': [
            'проспект Энергетиков, 25',
            'улица Коммуны, 15',
            'Ириновский проспект, 10',
        ],
    },
    {
        'district': 'Невский',
    ...
    },
    {
        ...
        'streets': [
            'проспект Стачек, 50',
            'улица Маршала Говорова, 10',
            'проспект Народного Ополчения, 25',
        ],
    },
    {
    ...
    # === ЮГО-ЗАПАДНЫЕ РАЙОНЫ ===
    {
        ...
        'base_price': 9_500_000,
        'streets': [
            'проспект Ветеранов, 100',
            'улица Добровольцев, 15',
            'Красное Село, улица Красных Командиров, 10',
            'Красное Село, улица Ленина, 20',
            'Красное Село, улица Лермонтова, 7',
        ],
    },
    # === ПРИГОРОДНЫЕ РАЙОНЫ ===
    {
        ...
        'streets': [
            'город Колпино, бульвар Победы, 10',
            'город Колпино, улица Анисимова, 15',
            'город Колпино, проспект Ленина, 20',
            'город Колпино, улица Октябрьская, 5',
        ],
    },
    {
        'district': 'Кронштадтский',
        'metro': 'Беговая',
        'base_price': 8_800_000,
        'streets': ['город Кронштадт, проспект Ленина, 30',
            'город Кронштадт, Советская улица, 15',
            'город Кронштадт, улица Карла Маркса, 10',
            'город Кронштадт, улица Розы Люксембург, 20',
        ],
    },
    {
        'district': 'Курортный',
        ...
        'streets': [
            'город Сестрорецк, улица Володарского, 10',
            'город Сестрорецк, Приморское шоссе, 25',
            'город Сестрорецк, улица Токарева, 15',
            'город Сестрорецк, улица Максима Горького, 20',
        ],
    },
    {
        'district': 'Петродворцовый',
        'metro': 'Автово',
        'base_price': 9_200_000,
        'streets': [
            'город Петергоф, Санкт-Петербургский проспект, 30',
            'город Петергоф, улица Аврова, 15',
            'город Петергоф, Ораниенбаумское шоссе, 10',
            'город Петергоф, улица Садовая, 20',
        ],
    },
    {
        'district': 'Пушкинский',
        ...
        'streets': [
            'город Пушкин, Октябрьский бульвар, 15',
            'город Пушкин, Московская улица, 20',
            'город Павловск, улица Мичурина, 12',
            'город Павловск, улица Садовая, 10',
        ],
    },
)
